    ...
    return (
        <section id="about">
            ...
            <div className="about-elements">
                ...
                <div className="elements-text-2">
                    <p>"Atenção e satisfação passa ser o maior diferencial deste Espaço". <span className='underline'>Bendita seja a sua Beleza!</span></p>
                </div>
                <div className="scheduling">
                    <p className='scheduling-p'>Para agendar seu horário:</p>
                    <button className='scheduling-button'>
                        <a href="https://api.whatsapp.com/send?phone=5583988710551&text=Ol%C3%A1%2C%20tudo%20bem%3F%20Desejo%20agendar%20um%20hor%C3%A1rio." rel="noreferrer" target="_blank" alt="Botão de encaminhamento Whatsapp">Agendar horário</a>
                    </button>
                </div>
            </div>
        </section>
